    ...
    return (
        <main className='p-10 ml-10 flex space-x-10'>
            <div className=' border-[8px]  border-[--primary] rounded-2xl h-[500px] z-5'>
                <Input className='border-[0px] w-2/3 h-1/5 rounded-br-2xl rounded-t-[0px] rounded-l-[0px] text-secondary ring-[0px] bg-primary font-bold text-3xl ' type="text" value={input} readOnly />
